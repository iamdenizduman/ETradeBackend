...
{
    public class EfUserOperationClaimReadRepository(AuthDbContext context) : EfEntityReadRepository<UserOperationClaim>(context), IUserOperationClaimReadRepository
    {
    }
}
